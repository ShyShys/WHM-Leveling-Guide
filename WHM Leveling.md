...
* HoT (Heal over Time): Actions that heal the target over time. These actions heal for their listed potency once every 3 seconds.
* Regen: Another word for HoT.
* DoT (Damage over Time): Actions that damage the target over time. These actions deal damage for their listed potency once every 3 seconds.
